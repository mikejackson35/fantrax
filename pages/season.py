...
ticktext = ['Sony','Amex','Farmers','AT&T','Waste Mgmt','Genesis','Mexico Open','Cognizant','Arnold Palmer','PLAYERS','Valspar','Houston Open','Valero','The Masters','RBC Heritage','AT&T Byron Nelson','Wells Fargo','PGA Championship','Charles Schwab','RBC Canadian']
...
cuts_made_hist1 = px.histogram(df[(df.week !=4) & (df.week !=15) & (df.week !=17)].sort_values('cuts_made', ascending=False),
                              x='cuts_made',
                              template='plotly_dark',
...
cuts_made_hist = px.histogram(df[(df.week !=4) & (df.week !=15) & (df.week !=17)].sort_values('cuts_made', ascending=False),
                    x='cuts_made',
                    text_auto='.2s',
